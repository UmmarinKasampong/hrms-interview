...
@section('title', 'แก้ไขฟอร์มขอเอกสารสำคัญ')
...
@section('contents')
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select class="form-select" aria-label="Default select example" id="type_doc" name="type_doc">
                                <option value="" {{ empty($data[0]->doc_type) ? 'selected' : '' }}>เลือกประเภทเอกสาร
                                </option>
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-select" aria-label="Default select example" id="doc_lang" name="doc_lang">
                                ...
                                <option value="ไทย" {{ $data[0]->doc_lang === 'ไทย' ? 'selected' : '' }}>ไทย</option>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select class="form-select" aria-label="Default select example" id="rec_form" name="rec_form">
                                <option value="" {{ empty($data[0]->doc_pick) ? 'selected' : '' }}>เลือกรูปแบบการรับ
                                </option>
                                <option value="รับด้วยตัวเอง"
                                    {{ $data[0]->doc_pick === 'รับด้วยตัวเอง' ? 'selected' : '' }}>รับด้วยตัวเอง</option>
                                <option value="ส่งไปรษณี" {{ $data[0]->doc_pick === 'รับด้วยตัวเอง' ? 'selected' : '' }}>
                                    ส่งไปรษณี ( กรอกที่อยู่ในรายละเอียด )</option>
    ...
    <script>
        ...
        $('#doc_Edit').on('submit', (e) => {
            e.preventDefault()
            let form = $('#doc_Edit')[0];

            let data = new FormData(form)
            data.append('form_id',  {!! json_encode($data[0]->doc_id) !!});
